...
export function connect() {
    ...
    sock.connect(port, host, function () {
        ...
        console.log('Socket local address:', sock.localAddress);
        console.log('Socket local port:', sock.localPort);
        console.log('Socket remote address:', sock.remoteAddress);
        console.log('Socket remote port:', sock.remotePort);
